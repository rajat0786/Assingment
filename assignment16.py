...
conn.execute("INSERT INTO BOOKS(BOOK_ID,TITLE_ID,LOCATION,GENRE,) VALUES (11023, '25893', 32, 'California', 20000.0)")nn.execute('''CREATE TABLE TITLE (TITLE_ID INT NOT NULL,
